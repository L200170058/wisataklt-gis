    ...
    var LocateControl = L.Control.extend({
        ...
        _drawMarker: function() {
            ...
            if (this.options.drawCircle) {
                ...
                if (!this._circle) {
                    this._circle = L.circle(latlng, this.options.circleRadius, style).addTo(this._layer);
                } else {
                    this._circle.setLatLng(latlng).setRadius(this.options.circleRadius).setStyle(style);
                }
            }
