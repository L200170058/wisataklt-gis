    ...
    <div class="col-md-12">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="/ft/add" type="button" class="btn btn-primary text-sm" ><i class="fa fa-plus text-sm"> Tambah</i>
            </a>
          </div>
          <!-- /.card-tools -->
        </div>
                ...
                <tbody>
                    ...
                    {{-- @foreach ($ft as $data)
                        <tr>
                            ...
                            <td ><img src="{{ asset('foto2')}}/{{ $data->foto }}" width="50px"></td>
                            <td class="text-center"> 
                              <a href="/ft/edit/{{ $data->id_foto }}" class="btn btn-sm btn-flat btn-warning"> <i class="fa fa-edit"> </i> </a> 
                              <button class="btn btn-sm btn-flat btn-danger" data-toggle="modal" data-target="#delete{{ $data->id_foto }}"><i class="fa fa-trash"></i></button>
