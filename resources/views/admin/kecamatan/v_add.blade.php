        ...
        <form action="/kecamatan/insert" method="POST">
          ...
          <div class="card-body">
            <div class="row">
                ...
                <div class="form-group">
                  <label>Pilih Warna</label>
                    <div class="input-group my-colorpicker2">
                      <input name="warna" type="text" class="form-control" placeholder="Silahkan Pilih Warna">
              ...
              <div class="col-sm-12">
                <label >Geojson</label>
                  <textarea name="geojson" rows="7" class="form-control" placeholder="Pilih geojson"></textarea>
                  <div class="text-danger">
                    @error('geojson')
                      {{ $message }} 
                    @enderror
